...
class IGPeriodicReportWizard(models.TransientModel):
    _name = 'ig.periodic.report.wizard'
    _description = 'IG Periodic Report Wizard'
    ...
    top_rank = fields.Integer(string="Top Ransk")
    show_attendance = fields.Boolean(string="Show Attendance")
    ...
    def generate_ig_periodic_report_wizard(self):
        ...
        return self.env.ref('classroom_management.action_report_ig_periodic_assessment').report_action(self)
