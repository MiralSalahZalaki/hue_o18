...
class IGMonthlytReportWizard(models.TransientModel):
    _name = 'ig.monthly.report.wizard'
    _description = 'IG Monthly Report Wizard'
    ...
    def generate_monthly_report(self):
        ...
        return self.env.ref('classroom_management.action_ig_monthly_report').report_action(self)   